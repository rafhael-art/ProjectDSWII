...
public class ExamenControlller {
    @Autowired
    private IExamenService _service;
    ...
    @PostMapping("")
    public ResponseEntity<?> save(@RequestBody Examen entity) {
        try {
    ...
    @PutMapping("")
    public ResponseEntity<?> edit(@RequestBody Examen entity) {
        try {
