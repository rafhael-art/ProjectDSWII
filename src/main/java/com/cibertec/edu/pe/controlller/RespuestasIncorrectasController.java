 ...
 */
@RestController
@RequestMapping("api/respuestasIncorrectas")
public class RespuestasIncorrectasController {
    @Autowired
    private IRespuestasInconrrectasService _service;
    ...
    @PostMapping("")
    public ResponseEntity<?> save(@RequestBody RespuestasIncorrectas entity) {
        try {
    ...
    @PutMapping("")
    public ResponseEntity<?> edit(@RequestBody RespuestasIncorrectas entity) {
        try {
